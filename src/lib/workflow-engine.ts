...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    id: "web-scraper",
    name: "Web Scraper",
    description: "Navigate to URL, extract content, save to file",
    category: "browser",
    inputSchema: { url: "string", outputPath: "string", selector: "string?" },
  ...
  },
  {
    id: "file-organizer",
    name: "File Organizer",
    description: "Scan folder, categorize files, move to appropriate folders",
    category: "file",
    inputSchema: { sourcePath: "string", rules: "object?" },
    steps: ["list-files", "categorize", "move-files"],
    icon: "📁",
  },
  {
    id: "pdf-processor",
    name: "PDF Processor",
    description: "Read PDF, extract text, summarize content",
    category: "data",
    inputSchema: { pdfPath: "string", outputFormat: "string?" },
    steps: ["read-pdf", "extract-text", "summarize", "save-output"],
    icon: "📄",
  },
  {
    id: "csv-analyzer",
    name: "CSV Analyzer",
    description: "Parse CSV, analyze data, generate report",
    category: "data",
    inputSchema: { csvPath: "string", analysisType: "string?" },
    steps: ["parse-csv", "analyze", "generate-report"],
    icon: "📊",
  },
  {
    id: "backup-manager",
    name: "Backup Manager",
    description: "Select files, create archive, copy to backup location",
    category: "automation",
    inputSchema: { sourcePaths: "array", backupPath: "string" },
    steps: ["collect-files", "create-archive", "copy-backup", "cleanup"],
    icon: "💾",
  },
  {
    id: "research-pipeline",
    name: "Research Pipeline",
    description: "Search web, gather information, synthesize findings",
    category: "research",
  ...
  },
  {
    ...
    description: "Collect data from multiple sources, analyze, generate formatted report",
    category: "data",
    inputSchema: { dataSources: "array", reportTemplate: "string?" },
    steps: ["gather-data", "process-data", "generate-report", "format-output"],
    icon: "📝",
  },
  {
    id: "batch-image-resize",
    name: "Batch Image Resize",
    description: "Find images in folder, resize to specified dimensions, save",
    category: "file",
    inputSchema: { folderPath: "string", width: "number", height: "number" },
    steps: ["find-images", "resize-each", "save-resized"],
    icon: "🖼️",
  },
  {
    id: "code-review-workflow",
    name: "Code Review Workflow",
    description: "Analyze code files, check for issues, generate improvement suggestions",
    category: "automation",
    inputSchema: { codePath: "string", language: "string?" },
    steps: ["find-code-files", "analyze-each", "generate-suggestions", "compile-report"],
    icon: "🔧",
  },
  {
    id: "content-aggregator",
    name: "Content Aggregator",
    description: "Fetch content from multiple URLs, combine, format for output",
    category: "research",
    inputSchema: { urls: "array", format: "string?" },
    steps: ["fetch-urls-parallel", "extract-content", "combine", "format-output"],
    icon: "📰",
  },
];
