...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.nivbot/nivbot.json`
...
- The script prints a `MEDIA:` line for nivbot to auto-attach on supported chat providers.
